...
abstract class GroupKeyInfo implements RustOpaqueInterface {
  ...
  Future<bool> matchesKeyId({required Hash otherKeyId});

  /// Create a new ChaCha20-Poly1305 GroupKeyInfo
  static Future<GroupKeyInfo> newChacha20Poly1305({required Hash keyId}) =>
...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Hash>>
abstract class Hash implements RustOpaqueInterface {}
