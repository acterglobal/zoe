  ...
  Widget _buildStep2() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Enter your group details to establish the connection',
          style: TextStyle(
            fontSize: 14,
            color: AppTheme.getTextSecondary(context),
          ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'The bot will verify your phone number is in the group before activating notifications.',
                  style: TextStyle(
                    fontSize: 14,
                    color: AppTheme.getTextPrimary(context),
                  ),
