...
class _PollResultsScreenState extends ConsumerState<PollResultsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: ZoeAppBar(title: L10n.of(context).pollResults),
      ),
      body: poll != null
          ? _buildBody(context, ref, poll)
          : Center(
              child: EmptyStateWidget(
                message: L10n.of(context).pollResultsNotFound,
              ),
            ),
    );
  }
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildPollResultsHeader(context, poll, ref),
            const SizedBox(height: 24),
            _buildPollResultsOptions(context, ref, poll),
          ],
        ),
      ),
    );
  ...
  Widget _buildPollResultsHeader(
  ...
  Widget _buildPollResultsOptions(
    BuildContext context,
    WidgetRef ref,
    PollModel poll,
  ) {
