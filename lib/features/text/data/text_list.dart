...
final textList = [
  ...
  TextModel(
    ...
    description: (
      plainText:
          'Tired of "Who\'s bringing what?" panic before every game? Stressed about organizing the bake sale? Community organizing doesn\'t have to be chaotic!\n\nThis sheet shows you how to use Zoe to coordinate sports teams, school groups, and volunteer organizations without the usual headaches. Learn to keep everyone informed, track sign-ups clearly, and ensure nothing falls through the cracks.',
      htmlText:
