...
final tasks = [
  ...
  // Direct sheet-level tasks (parentId: 'sheet-1')
  TaskModel(
    id: 'task-direct-1',
    sheetId: 'sheet-1',
    parentId: 'sheet-1',
    ...
    description: (
      plainText:
          'Take some time to clean up and organize your digital workspace. A well-organized environment leads to better productivity.',
      htmlText:
          '<p>Take some time to clean up and organize your digital workspace. A well-organized environment leads to better productivity.</p>',
    ),
    isCompleted: false,
  ...
  TaskModel(
    ...
    sheetId: 'sheet-1',
    parentId: 'sheet-1',
    title: 'Set up your daily routine template',
    orderIndex: 11,
    description: (
      plainText:
          'Create a template for your daily routine that you can reuse. Include morning rituals, work blocks, and evening wind-down activities.',
      htmlText:
          '<p>Create a template for your daily routine that you can reuse. Include morning rituals, work blocks, and evening wind-down activities.</p>',
    ),
    isCompleted: false,
  ...
  TaskModel(
    ...
    description: (
      plainText:
          'Ensure all your important documents are backed up to a secure location. Regular backups prevent data loss and give peace of mind.',
      htmlText:
          '<p>Ensure all your important documents are backed up to a secure location. Regular backups prevent data loss and give peace of mind.</p>',
    ),
    isCompleted: false,
